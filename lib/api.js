...
/**
 * @param {{market: string, horizonHours: number, windowHours: number, apiKey?: string, userAgent: string}} config
 */
...
/**
 * @param {{market: string, horizonHours: number, apiKey?: string, userAgent: string}} config
 */
